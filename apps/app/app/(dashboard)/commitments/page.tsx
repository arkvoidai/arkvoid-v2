  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <h1 className="text-3xl font-light tracking-tight text-white">Commitments</h1>
        <p className="max-w-2xl text-sm leading-6 text-[#6e6c76]">Monitor promises, obligations, and follow-up actions created by AI workflows.</p>
      </div>
      ...
      <section className="rounded-xl border border-[#1a1a1a] bg-[#080808] p-8">
        <div className="flex min-h-[260px] flex-col items-center justify-center rounded-lg border border-dashed border-[#222] bg-black/40 p-8 text-center">
          ...
          <h2 className="text-lg font-normal text-white">No commitments yet</h2>
